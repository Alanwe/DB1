...
# MAGIC %md Archive Models into Pickle file
...
# MAGIC %md
# MAGIC Save Pickle file as Azure Blob
...
block_blob_service.create_blob_from_path("models","TextClassify2" ,"/tmp/model.pkl")